...
public class PhoneCallReceiver extends BroadcastReceiver {
    ...
    private void showNotification(Context context, String numberInsert) {

        Intent i = new Intent(context, InitTagActivity.class);
        i.putExtra("numberInsert", numberInsert);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals("android.intent.action.NEW_OUTGOING_CALL")) {
            ...
            showNotification(savedContext, intent.getExtras().getString("android.intent.extra.PHONE_NUMBER"));
            return;
        }
 ...
 //   protected abstract void onMissedCall(String number, Date start);
    ...
    public class PhonecallStartEndDetector extends PhoneStateListener {
     ...
     //     showNotification(savedContext, incomingNumber);
            ...
            switch (state) {
                ...
                case TelephonyManager.CALL_STATE_IDLE:
                    ...
                    showNotification(savedContext, savedNumber);
                    ...
                    if(lastState == TelephonyManager.CALL_STATE_RINGING){
                       ...
                       showNotification(savedContext, savedNumber);
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                Intent i = new Intent(savedContext, IncomingCallActivity.class);
                                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                i.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                savedContext.startActivity(i);
                            }
                        }, 2000);
                    }
                    break;
