...
/**
 * Created by guest on 20/5/15.
 */
public class EmployeeProvider extends ContentProvider {

    static final String PROVIDER_NAME = "com.housing.provider.Company";
    ...
    static{
        ...
        uriMatcher.addURI(PROVIDER_NAME, "Employee/#", EMP_ID);
    }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case EMPLOYEES:
                ...
                break;
            case EMP_ID:
                count = db.update(EMPLOYEES_TABLE_NAME, values, _ID +
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
             ...
             */
            case EMPLOYEES:
                return "vnd.android.cursor.dir/vnd.housing.employees";
            /**
             * Get a particular student
             */
            case EMP_ID:
                return "vnd.android.cursor.item/vnd.housing.employees";
            default:
