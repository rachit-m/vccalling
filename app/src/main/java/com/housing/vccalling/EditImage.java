...
public class EditImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Bitmap bmp = ((BitmapDrawable) getApplicationContext().getResources().getDrawable(R.drawable.musica)).getBitmap();
...
//  Log.d("IMAGE", "IMAGE HEIGHT--" + ImageEffects.getOriginalimage().getHeight() + "Image WIdth" + ImageEffects.getOriginalimage().getWidth());
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Create Dubtrub"));
